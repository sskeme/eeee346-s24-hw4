...
/**
 * Removes "_" from the beginning of a string.
 *
 * @param dest - resulting string without "_" at the beginning
 *               (e.g., "____hello" --> "hello")
 * @param src - original string
 */
